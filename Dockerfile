...
RUN cp /workdir/files/tomcat-users.xml /opt/tomcat/conf/tomcat-users.xml
RUN cp /workdir/files/manager_META-INF_context.xml /opt/tomcat/webapps/manager/META-INF/context.xml
RUN cp /workdir/files/host-manager_META-INF_context.xml /opt/tomcat/webapps/host-manager/META-INF/context.xml
